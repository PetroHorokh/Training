...
public partial class RentContext : DbContext
{
    ...
    public virtual DbSet<AccommodationRoom> AccommodationRooms { get; set; } = null!;
    ...
    public virtual DbSet<Impost> Imposts { get; set; } = null!;
    ...
    public virtual DbSet<Models.Rent> Rents { get; set; } = null!;
    ...
    public virtual DbSet<VwCertificateForTenant> VwCertificateForTenants { get; set; } = null!;

    public virtual DbSet<VwRoomsWithTenant> VwRoomsWithTenants { get; set; } = null!;

    public virtual DbSet<VwTenantAssetPayment> VwTenantAssetPayments { get; set; } = null!;
